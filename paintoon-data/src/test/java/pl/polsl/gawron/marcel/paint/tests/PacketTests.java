package pl.polsl.gawron.marcel.paint.tests;
...
import pl.polsl.gawron.marcel.paintoonData.protocol.packets.responses.ResponsePixelHistory;
...
public class PacketTests {
    ...
    public void ResponsePixelHistorySerializationTest() {
        ...
        entry1.setX(3);
        entry1.setY(5);
        entry1.setRedComponent(0);
        entry1.setGreenComponent(0);
        entry1.setBlueComponent(255);
        ...
        entry2.setX(3);
        entry2.setY(5);
        entry2.setRedComponent(0);
        entry2.setGreenComponent(0);
        entry2.setBlueComponent(255);
